      ...
      <div className="w-full max-w-5xl xl:max-w-7xl mx-auto pt-32 md:pt-40 lg:pt-48 pb-24 md:pb-32 relative z-10 flex flex-col items-center justify-center text-center">
        ...
        >
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            {/* Sub-headline & Bio */}
            <motion.div custom={2} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.1 }} className="flex flex-col items-center text-center w-full gap-8 md:gap-12">
              <div
