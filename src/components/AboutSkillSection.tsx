        ...
        <div className="w-full max-w-6xl mx-auto" style={{ marginBottom: '3.5rem' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-24 items-stretch">
            ...
            >
              ...
              {/* Terminal window */}
              <div
                className="border-2 border-black overflow-hidden w-full h-full flex flex-col"
                style={{ background: '#0F172A', boxShadow: '10px 10px 0px #000' }}
              >
                {/* Title bar */}
                <div
                  className="flex items-center gap-2 px-4 py-2.5 border-b-2 shrink-0"
                ...
                {/* Code content */}
                <div className="code-terminal p-4 md:p-5 lg:p-6 flex-1 flex flex-col">
              ...
              <div className="flex gap-3 md:gap-4 flex-wrap justify-center" style={{ marginTop: '1.5rem', marginBottom: '1.5rem' }}>
                {categories.map(cat => (
                  <button
                    ...
                    className="px-6 sm:px-10 md:px-14 py-3 sm:py-4 md:py-5 text-sm sm:text-base md:text-lg lg:text-xl font-black uppercase tracking-widest border-2 md:border-4 border-black transition-transform duration-200 hover:-translate-y-1.5 hover:-translate-x-1.5"
                    style={{
              ...
              {filteredSkills.map((skill, si) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex-1 min-w-0 flex flex-col justify-center">
                    ...
                    {/* Progress bar */}
                    <div
                      className="w-full h-2 md:h-2.5 border border-white/20 group-hover:border-black/30 transition-colors duration-200"
